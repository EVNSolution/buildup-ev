 ...
 * 검증할 곳이 흩어진다.
 *
 * ⚠️ 여기를 고치면 **제출 전** 체크리스트는 따라간다(2026-09-15 — 작성을 시작했다고 고친 항목이 안 들어가 제보).
 *    **제출한** 것은 그때 항목 그대로다 — 3개월 전에 합격 처리한 항목의 뜻이 소급해서 바뀌면 그 기록은 근거가 되지 못한다.
...
export function ChecklistTab() {
  ...
  return (
    <div style={s.root}>
      ...
      <p style={s.note}>
        {t('여기를 고치면 아직 제출하지 않은 체크리스트에도 반영됩니다. 문구를 바꾼 항목은 판정을 다시 해야 합니다. 이미 제출한 체크리스트는 그대로 남습니다.')}
      </p>
