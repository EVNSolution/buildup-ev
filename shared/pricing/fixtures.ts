...
export const QUOTE_EXPECTED = {
  ...
  /**
   * ⚠️ 엑셀 M26(45,070,450)과 **일부러 다르다**.
   *
   * 엑셀은 보조금까지 뺀 금액에서 부가세를 나눴는데, 전기차 보조금은 정부가 주는 돈이지
   * 판매가를 깎은 것이 아니라 세금계산서 금액이 줄지 않는다. 환급액은 보조금을 빼기 전
   * 금액에서 나와야 한다(2026-08-12 확정, Ver1.21 엔진 calcPrice 도 원래 이 기준).
   *
   * 결제금액 49,577,500 · 환급 기준 70,267,500 → 환급 6,387,950 → 49,577,500 − 6,387,950
   * 엑셀을 이 기준으로 고치기 전까지 M26 과는 어긋난다.
   */
  vat_refund_price: 43_189_550,
};
